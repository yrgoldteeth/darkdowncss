...
This CSS file is an adaptation of [Markdown.css](http://kevinburke.bitbucket.org/markdowncss)
given a dark color scheme.  This markdown test file was also adapted from the 
original Markdown.css [test file.](http://kevinburke.bitbucket.org/markdowncss/sample.html)
